                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="relative h-[298px] content-end md:h-auto">
                            <div className="mx-auto mb-[104px] flex flex-1 gap-[21px]">
                                <Button color="black_900" shape="round" className="min-w-[184px] font-quicksand">
                                    Add your child
                                </Button>
                                <Button color="black_900" shape="round" className="min-w-[162px] font-quicksand">
                                    Try AI Assist
                                </Button>
                            </div>
                            <Text
                                size="textxl"
                                as="p"
                                className="absolute bottom-0 left-0 right-0 top-0 m-auto h-max w-full leading-[29px]"
                            >
                                When you sign up, we'll ask a few questions about your child's interests and personality. Our advanced A.I. analyzes this information to recommend gifts that your child will love, ensuring every present is a perfect match.
                            </Text>
                        </div>
                    </div>
                </div>
            ...
            <div className="relative z-[1] flex items-start justify-center bg-white-a700 md:flex-col">
                <div className="mt-14 flex w-[42%] flex-col items-start md:w-full md:px-5">
                    ...
                    <Text size="textxl" as="p" className="w-[88%] leading-[29px] md:w-full">
                        Create and manage gift lists for each of your children. Edit, add, or remove items as you see fit, keeping the list updated and relevant to your child's evolving interests.
                    </Text>
                    <Button color="black_900" shape="round" className="mt-[38px] min-w-[184px] font-quicksand">
                        + New Gift List
                    </Button>
                </div>
                <Img
            ...
            <div className="flex items-center justify-between gap-5 bg-amber-200_01 md:flex-col">
                ...
                <div className="flex w-[48%] flex-col items-start md:w-full md:px-5">
                    ...
                    <Text size="textxl" as="p" className="w-[82%] leading-[29px] md:w-full">
                        Once your list is complete, share it effortlessly with friends, family, and even your child's classmates through a unique link. This makes it easy for others to see what gifts your child would love.
                    </Text>
                    <Button color="black_900" shape="round" className="mt-[38px] min-w-[126px] font-quicksand">
                        Try now
                    </Button>
                </div>
            </div>
